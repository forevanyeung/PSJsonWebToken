...
# Create an RSA-SHA256 signed JWT with a private key
$p = "~/certs/private.pem"
$private = Get-Content $p
$key = $private[1..($private.Length-2)]
$keyB = [System.Convert]::FromBase64String($key)
$jwt = New-JsonWebToken -Claims @{sub="username@company.com"} -HashAlgorithm SHA256 -PrivateKey $keyB
